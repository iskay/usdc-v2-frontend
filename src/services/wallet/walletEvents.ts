...
export interface NamadaAccountsChangedPayload {
...
export interface NamadaDisconnectedPayload {
  reason?: string
}
...
interface WalletEventPayloadMap {
  ...
  'namada:accountsChanged': NamadaAccountsChangedPayload
  'namada:disconnected': NamadaDisconnectedPayload | undefined
}
